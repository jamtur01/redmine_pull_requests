...
A copy of the plugin can be downloaded from {Little Stream Software}[https://projects.littlestreamsoftware.com/projects/redmine-simple-sup/files] or from {GitHub}[http://github.com/edavis10/redmine_pull_request]
